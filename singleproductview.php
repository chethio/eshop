            ...
            <div class="col-12 mt-0 singleproduct">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-2 order-lg-1 order-2">
                                <ul>
                                    ...
                                    <li
                                        ...
                                        <img style="background-size: contain;" class="mt-1 mb-1" height="140px"
                                            src="<?php echo $d["code"]; ?>" id="pimg<?php echo $x; ?>"
                                            onclick="loadmainimg(<?php echo $x; ?>);">
                                    </li>
                                    ...
                                    <li
                                        class="d-flex flex-column justify-content-center align-items-center border border-1 border-secondary">
                                        <img class="mt-1 mb-1" height="140px" src="resources/2561351_camera_icon.svg"
                                            alt="">
                                    </li>
                                    <li
                                        class="d-flex flex-column justify-content-center align-items-center border border-1 border-secondary">
                                        <img height="140px" class="mt-1 mb-1" src="resources/2561351_camera_icon.svg"
                                            alt="">
                                    </li>
                                    <li
                                        class="d-flex flex-column justify-content-center align-items-center border border-1 border-secondary">
                            ...
                            <div class="col-lg-4 order-2 order-lg-1 d-none d-lg-block">
                                <div class=" align-items-center border border-1 border-secondary p-3">
                                    <div id="mainimg"
                                        style="background-image: url('<?php echo $image1; ?>'); background-repeat: no-repeat; background-size: contain; height: 450px;">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-4 col-lg-12">
                                                <label
                                                    class="form-label fs-4 fw-bold mt-0"><?php echo $pd["title"]; ?></label>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <label
                                                    class="fw-bold mt-1 fs-4 ">Rs<?php echo $pd["price"]; ?>.00</label>

                                                <label
                                                    class="fw-bold mt-1 fs-6 text-danger "><del>Rs.<?php $a = $pd["price"];
                                                                                                            $newv = ($a / 100) * 5;
                                                                                                            $val = $a + $newv;
                                                                                                            echo $val; ?></del></label>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div
                                                                class="border border-1 border-secondary rounded overflow-hidden float-start position-relative">
                                                                <span class="mt-2">Quantity:</span>
                                                                <input id="qtyinput"
                                                                    style=" height: 40px; outline: none;"
                                                                    class="border-0 fs-6 fw-bold text-start "
                                                                    type="text" pattern="[0-9]*" value="1" />

                                                                <div class="qty-btns position-absolute">
                                                                    <div
                                                                        class="d-flex flex-column align-items-center border border-1 border-secondary qty-inc">
                                                                        <i class="fas fa-chevron-up"
                                                                            onclick="qtyinc(<?php echo $pd['qty']; ?>);"></i>
                                                                    </div>

                                                                    <div
                                                                        class="d-flex flex-column align-items-center border border-1 border-secondary qty-dec">
                                                    ...
                                                    <div class="col-12 mt-3">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-6 d-grid">
                                                                <button onclick="paynow( <?php echo $pid; ?>);"
                                                                    type="submit" id="payhere-payment"
                    ...
                    <div class="col-12 bg-white">
                        <div
                            class="row d-block me-0 ms-0 mt-4 mb-3 border border-start-0 border-end-0 border-top-0 border-bottom-1 border-primary">
                            <div class="col-md-6">
                            ...
                            <div class="col-8 col-lg-10 offset-2 offset-lg-1 justify-content-center">
                                <div class="row p-2">
                                    ...
                                    <div class="card me-1" style="width: 18rem;">
                                        <img src="<?php echo $imaged["code"]; ?>" class="card-img-top image-fluid">
                                        <div class="card-body">
                                            <h5 class="card-title"><?php echo $bd["title"]; ?></h5>
                                            <p class="card-text">Rs.<?php echo $bd["price"]; ?>.00</p>
                                            <a href="#" class="btn btn-primary">Add To Cart</a>
                                            <a href="#" class="btn btn-success">Buy Now</a>
                                            <a class="me-1 mt-1 fs-5" href=""><i
                                                    class="fas fa-heart mt-2 fs-4 text-black-50"></i></a>
                                        </div>
                                    </div>
                                    <?php
                                        }
