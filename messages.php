...
?>
  ...
  background-image: linear-gradient(90deg, #74ebd5 0%, #9face6 100%);" onload=" refresher('<?php echo $email; ?>','chatrow');">
                                    ...
                                    <div class="row bg-white">
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="input-group-append">
                                                <button id="button-addon2" class="btn btn-link fs-1" onclick="sendmessage('<?php echo $_GET['email']; ?>','msgtxt');"> <i class="bi bi-cursor-fill"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
